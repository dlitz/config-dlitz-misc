% config-dlitz-bashrc-root(SECTION) | User Commands
%
% "October 24 2023"
...
config-dlitz-bashrc-root - program to do something

# SYNOPSIS

**config-dlitz-bashrc-root** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**config-dlitz-bashrc-root** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **config-dlitz-bashrc-root** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**config-dlitz-bashrc-root** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    config-dlitz-bashrc-root. See **foo.conf**(5) for further details.
...
**config-dlitz-bashrc-root** provides some return codes, that can be used in scripts:
